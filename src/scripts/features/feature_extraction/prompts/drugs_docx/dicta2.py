        ...
        message = [
            {
                ...
                "content": f"""
                    ...
                    לדוגמא: [קוקאין], [קנביס], [MDMA], [הרואין].
                    אם יש יותר מסוג אחד, תחזיר את כל הסוגים בטקסט בתבנית הנ"ל.
                """
            }
        ]
        answer = self.generate_answer(message)
        ...
        message = [
            {
                ...
                "content": f"""
                    ...
                    לדוגמה: [100 - גרם], [2 - קילוגרם], [3 - ליטר], [5 - קילוגרם], [10.4 - מ"ל], [0.5 - ק"ג], [0.425 - גרם], [300- שקיות], [10 - קפסולות].
                    אם יש יותר מכמות אחת, תחזיר את כל הכמויות בטקסט בתבנית הנ"ל.
