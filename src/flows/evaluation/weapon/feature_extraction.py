...
class Evaluation():
    ...
    def feature_extraction_eval(self, ignore_columns, feature_extraction_path=None, feature_extraction_df=None, case_mapping_dict=None, is_organizing = False, error_analysis=False):
        """
        ...
        fe_df.replace('HELD_WAY_WEP', 'HELD_WAY', inplace=True)
...
def main(params, domain):     
    ...
    save_path = params['save_path'].format(domain=domain, date=get_date())
    ...
    eval_.feature_extraction_eval(ignore_columns = params['ignore_columns'],
                                  ...
                                  is_organizing = params['is_organizing'],
                                  error_analysis=True)
